...
async function resolve(
  ...
  // Check if chainId is valid before using Object.hasOwn to avoid issues with undefined
  if (chainId != null && typeof chainId === "number" && !isNaN(chainId) && Object.hasOwn(_mockChains, chainId)) {
    if (!rpcUrl) {
